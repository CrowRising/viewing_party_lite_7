...
RSpec.describe 'User Dashboard', type: :feature do
  ...
  describe 'User dashboard with Viewing Parties' do
    before(:each) do
      ...
      @user1 = User.create!(name: 'Bob', email: 'bobbEE@aol.com', password: 'password')
      @user2 = User.create!(name: 'Sally', email: 'SeaShellZ@aol.com', password: 'something')
      @user3 = User.create!(name: 'Rizzo', email: 'RizzNizz@ghostmail.com', password: 'anotherPassword')
